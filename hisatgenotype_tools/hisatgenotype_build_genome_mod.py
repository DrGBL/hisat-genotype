...
def build_genotype_genome(base_fname,                          
    ...
    print('Reading snp')
    genotype_vars = typing_common.read_variants('common_all_20180418_chr_fixed.snp')
    
    print('Reading haplotype')
    # Read haplotypes
    genotype_haplotypes = typing_common.read_haplotypes('common_all_20180418_chr_fixed.haplotype')
...
if __name__ == '__main__':
    ...
    build_genotype_genome(base_fname,
                          args.inter_gap,
                          args.intra_gap,
                          args.threads,
                          database_list,
